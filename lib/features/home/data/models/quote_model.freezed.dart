...
@override
String toString() {
  return 'QuoteModel(id: $id, text: $text, author: $author, scripture: $scripture, chapter: $chapter, verse: $verse)';
}
...
class _QuoteModel extends QuoteModel {
  const _QuoteModel({required this.id, required this.text, required this.author, required this.scripture, this.chapter, this.verse}): super._();
