...
mixin _$CommentModel {
 ...
 String get contentType;// 'story' or 'post'
 String get userId; String get userName; String get userAvatar; String get text; DateTime get createdAt; int get likeCount; String? get parentCommentId; List<CommentModel> get replies; int get depth; bool get isCollapsed; bool get isLikedByCurrentUser;
...
@override
String toString() {
  return 'CommentModel(id: $id, contentId: $contentId, contentType: $contentType, userId: $userId, userName: $userName, userAvatar: $userAvatar, text: $text, createdAt: $createdAt, likeCount: $likeCount, parentCommentId: $parentCommentId, replies: $replies, depth: $depth, isCollapsed: $isCollapsed, isLikedByCurrentUser: $isLikedByCurrentUser)';
}
...
@useResult
$Res call({
 String id, String contentId, String contentType, String userId, String userName, String userAvatar, String text, DateTime createdAt, int likeCount, String? parentCommentId, List<CommentModel> replies, int depth, bool isCollapsed, bool isLikedByCurrentUser
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String contentId,  String contentType,  String userId,  String userName,  String userAvatar,  String text,  DateTime createdAt,  int likeCount,  String? parentCommentId,  List<CommentModel> replies,  int depth,  bool isCollapsed,  bool isLikedByCurrentUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String contentId,  String contentType,  String userId,  String userName,  String userAvatar,  String text,  DateTime createdAt,  int likeCount,  String? parentCommentId,  List<CommentModel> replies,  int depth,  bool isCollapsed,  bool isLikedByCurrentUser)  $default,) {final _that = this;
switch (_that) {
case _CommentModel():
return $default(_that.id,_that.contentId,_that.contentType,_that.userId,_that.userName,_that.userAvatar,_that.text,_that.createdAt,_that.likeCount,_that.parentCommentId,_that.replies,_that.depth,_that.isCollapsed,_that.isLikedByCurrentUser);case _:
  throw StateError('Unexpected subclass');
