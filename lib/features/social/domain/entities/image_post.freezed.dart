...
mixin _$ImagePost {
 ...
 String get id; String get imageUrl;/// All image URLs for this post (multi-photo). When empty, [imageUrl] is the single image.
 List<String> get mediaUrls; String? get caption; String? get title; String? get location; double get aspectRatio; DateTime? get createdAt; DateTime? get scheduledAt; DateTime? get publishedAt; String? get status; String? get authorId; User? get authorUser; int get likes; int get commentCount; int get shareCount; bool get isLikedByCurrentUser; bool get isFavorite; List<String> get tags; List<PostMention> get mentions; String? get repostedPostId; String? get repostedPostType; String? get repostedMediaUrl; String? get repostedThumbnailUrl; String? get repostedCaption; String? get repostedAuthorId; String? get repostedAuthorName; String? get repostedAuthorUsername; String? get repostedAuthorAvatarUrl;
...
@useResult
$Res call({
 String id, String imageUrl, List<String> mediaUrls, String? caption, String? title, String? location, double aspectRatio, DateTime? createdAt, DateTime? scheduledAt, DateTime? publishedAt, String? status, String? authorId, User? authorUser, int likes, int commentCount, int shareCount, bool isLikedByCurrentUser, bool isFavorite, List<String> tags, List<PostMention> mentions, String? repostedPostId, String? repostedPostType, String? repostedMediaUrl, String? repostedThumbnailUrl, String? repostedCaption, String? repostedAuthorId, String? repostedAuthorName, String? repostedAuthorUsername, String? repostedAuthorAvatarUrl
});
...
/// Create a copy of ImagePost
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? imageUrl = null,Object? mediaUrls = null,Object? caption = freezed,Object? title = freezed,Object? location = freezed,Object? aspectRatio = null,Object? createdAt = freezed,Object? scheduledAt = freezed,Object? publishedAt = freezed,Object? status = freezed,Object? authorId = freezed,Object? authorUser = freezed,Object? likes = null,Object? commentCount = null,Object? shareCount = null,Object? isLikedByCurrentUser = null,Object? isFavorite = null,Object? tags = null,Object? mentions = null,Object? repostedPostId = freezed,Object? repostedPostType = freezed,Object? repostedMediaUrl = freezed,Object? repostedThumbnailUrl = freezed,Object? repostedCaption = freezed,Object? repostedAuthorId = freezed,Object? repostedAuthorName = freezed,Object? repostedAuthorUsername = freezed,Object? repostedAuthorAvatarUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String imageUrl,  List<String> mediaUrls,  String? caption,  String? title,  String? location,  double aspectRatio,  DateTime? createdAt,  DateTime? scheduledAt,  DateTime? publishedAt,  String? status,  String? authorId,  User? authorUser,  int likes,  int commentCount,  int shareCount,  bool isLikedByCurrentUser,  bool isFavorite,  List<String> tags,  List<PostMention> mentions,  String? repostedPostId,  String? repostedPostType,  String? repostedMediaUrl,  String? repostedThumbnailUrl,  String? repostedCaption,  String? repostedAuthorId,  String? repostedAuthorName,  String? repostedAuthorUsername,  String? repostedAuthorAvatarUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ImagePost() when $default != null:
return $default(_that.id,_that.imageUrl,_that.mediaUrls,_that.caption,_that.title,_that.location,_that.aspectRatio,_that.createdAt,_that.scheduledAt,_that.publishedAt,_that.status,_that.authorId,_that.authorUser,_that.likes,_that.commentCount,_that.shareCount,_that.isLikedByCurrentUser,_that.isFavorite,_that.tags,_that.mentions,_that.repostedPostId,_that.repostedPostType,_that.repostedMediaUrl,_that.repostedThumbnailUrl,_that.repostedCaption,_that.repostedAuthorId,_that.repostedAuthorName,_that.repostedAuthorUsername,_that.repostedAuthorAvatarUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String imageUrl,  List<String> mediaUrls,  String? caption,  String? title,  String? location,  double aspectRatio,  DateTime? createdAt,  DateTime? scheduledAt,  DateTime? publishedAt,  String? status,  String? authorId,  User? authorUser,  int likes,  int commentCount,  int shareCount,  bool isLikedByCurrentUser,  bool isFavorite,  List<String> tags,  List<PostMention> mentions,  String? repostedPostId,  String? repostedPostType,  String? repostedMediaUrl,  String? repostedThumbnailUrl,  String? repostedCaption,  String? repostedAuthorId,  String? repostedAuthorName,  String? repostedAuthorUsername,  String? repostedAuthorAvatarUrl)  $default,) {final _that = this;
switch (_that) {
case _ImagePost():
return $default(_that.id,_that.imageUrl,_that.mediaUrls,_that.caption,_that.title,_that.location,_that.aspectRatio,_that.createdAt,_that.scheduledAt,_that.publishedAt,_that.status,_that.authorId,_that.authorUser,_that.likes,_that.commentCount,_that.shareCount,_that.isLikedByCurrentUser,_that.isFavorite,_that.tags,_that.mentions,_that.repostedPostId,_that.repostedPostType,_that.repostedMediaUrl,_that.repostedThumbnailUrl,_that.repostedCaption,_that.repostedAuthorId,_that.repostedAuthorName,_that.repostedAuthorUsername,_that.repostedAuthorAvatarUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String imageUrl,  List<String> mediaUrls,  String? caption,  String? title,  String? location,  double aspectRatio,  DateTime? createdAt,  DateTime? scheduledAt,  DateTime? publishedAt,  String? status,  String? authorId,  User? authorUser,  int likes,  int commentCount,  int shareCount,  bool isLikedByCurrentUser,  bool isFavorite,  List<String> tags,  List<PostMention> mentions,  String? repostedPostId,  String? repostedPostType,  String? repostedMediaUrl,  String? repostedThumbnailUrl,  String? repostedCaption,  String? repostedAuthorId,  String? repostedAuthorName,  String? repostedAuthorUsername,  String? repostedAuthorAvatarUrl)?  $default,) {final _that = this;
switch (_that) {
case _ImagePost() when $default != null:
return $default(_that.id,_that.imageUrl,_that.mediaUrls,_that.caption,_that.title,_that.location,_that.aspectRatio,_that.createdAt,_that.scheduledAt,_that.publishedAt,_that.status,_that.authorId,_that.authorUser,_that.likes,_that.commentCount,_that.shareCount,_that.isLikedByCurrentUser,_that.isFavorite,_that.tags,_that.mentions,_that.repostedPostId,_that.repostedPostType,_that.repostedMediaUrl,_that.repostedThumbnailUrl,_that.repostedCaption,_that.repostedAuthorId,_that.repostedAuthorName,_that.repostedAuthorUsername,_that.repostedAuthorAvatarUrl);case _:
  return null;
...
class _ImagePost extends ImagePost {
  const _ImagePost({required this.id, required this.imageUrl, final  List<String> mediaUrls = const [], this.caption, this.title, this.location, this.aspectRatio = 1.0, this.createdAt, this.scheduledAt, this.publishedAt, this.status, this.authorId, this.authorUser, this.likes = 0, this.commentCount = 0, this.shareCount = 0, this.isLikedByCurrentUser = false, this.isFavorite = false, final  List<String> tags = const [], final  List<PostMention> mentions = const [], this.repostedPostId, this.repostedPostType, this.repostedMediaUrl, this.repostedThumbnailUrl, this.repostedCaption, this.repostedAuthorId, this.repostedAuthorName, this.repostedAuthorUsername, this.repostedAuthorAvatarUrl}): _mediaUrls = mediaUrls,_tags = tags,_mentions = mentions,super._();
...
/// Create a copy of ImagePost
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? imageUrl = null,Object? mediaUrls = null,Object? caption = freezed,Object? title = freezed,Object? location = freezed,Object? aspectRatio = null,Object? createdAt = freezed,Object? scheduledAt = freezed,Object? publishedAt = freezed,Object? status = freezed,Object? authorId = freezed,Object? authorUser = freezed,Object? likes = null,Object? commentCount = null,Object? shareCount = null,Object? isLikedByCurrentUser = null,Object? isFavorite = null,Object? tags = null,Object? mentions = null,Object? repostedPostId = freezed,Object? repostedPostType = freezed,Object? repostedMediaUrl = freezed,Object? repostedThumbnailUrl = freezed,Object? repostedCaption = freezed,Object? repostedAuthorId = freezed,Object? repostedAuthorName = freezed,Object? repostedAuthorUsername = freezed,Object? repostedAuthorAvatarUrl = freezed,}) {
