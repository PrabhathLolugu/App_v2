...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Conversation> conversations)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ChatListInitial() when initial != null:
return initial();case ChatListLoading() when loading != null:
return loading();case ChatListLoaded() when loaded != null:
return loaded(_that.conversations);case ChatListError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Conversation> conversations)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case ChatListInitial():
return initial();case ChatListLoading():
return loading();case ChatListLoaded():
return loaded(_that.conversations);case ChatListError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Conversation> conversations)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case ChatListInitial() when initial != null:
return initial();case ChatListLoading() when loading != null:
return loading();case ChatListLoaded() when loaded != null:
...
class ChatListLoaded extends ChatListState {
  const ChatListLoaded(final  List<Conversation> conversations): _conversations = conversations,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatListLoaded&&const DeepCollectionEquality().equals(other._conversations, _conversations));
}
...
@override
String toString() {
  return 'ChatListState.loaded(conversations: $conversations)';
}
...
class ChatListError extends ChatListState {
  const ChatListError(this.message): super._();
