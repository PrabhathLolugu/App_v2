...
const List<MigrationCommand> _migration_20260129202000_up = [
...
const List<MigrationCommand> _migration_20260129202000_down = [
...
@Migratable(
  version: '20260129202000',
  up: _migration_20260129202000_up,
  down: _migration_20260129202000_down,
)
class Migration20260129202000 extends Migration {
